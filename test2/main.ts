...
async function main() {
  ...
  const rolePermissions = [
    ...
    { role_id: 'r3', permission_id: 'p2' }, // 添加系统管理权限（父菜单）
    { role_id: 'r3', permission_id: 'p6' }, // 添加商城管理权限（父菜单）
    { role_id: 'r3', permission_id: 'p3' }, // 用户管理（子菜单）
    { role_id: 'r3', permission_id: 'p4' }, // 菜单管理（子菜单）
    { role_id: 'r3', permission_id: 'p7' }, // 订单管理（子菜单）
    { role_id: 'r3', permission_id: 'p8' }, // 商品管理（子菜单）

    // 技术部主管 - 系统管理、商城管理、用户管理、菜单管理、部门管理、订单管理、商品管理、财务管理
    { role_id: 'r4', permission_id: 'p2' }, // 系统管理权限
    { role_id: 'r4', permission_id: 'p6' }, // 商城管理权限
    ...
    // 客服部职员 - 商城管理 + 订单管理
    { role_id: 'r5', permission_id: 'p6' }, // 商城管理权限（父菜单）
    { role_id: 'r5', permission_id: 'p7' }, // 订单管理权限（子菜单）

    // 客服部主管 - 系统管理 + 商城管理 + 用户管理、订单管理、商品管理
    { role_id: 'r6', permission_id: 'p2' }, // 添加系统管理权限（父菜单）
    { role_id: 'r6', permission_id: 'p6' }, // 商城管理权限（父菜单）
    { role_id: 'r6', permission_id: 'p3' }, // 用户管理（子菜单）
    { role_id: 'r6', permission_id: 'p7' }, // 订单管理（子菜单）
    { role_id: 'r6', permission_id: 'p8' }, // 商品管理（子菜单）

    // 财务部职员 - 商城管理、订单管理、商品管理、财务管理
    { role_id: 'r7', permission_id: 'p6' }, // 商城管理权限
    { role_id: 'r7', permission_id: 'p7' },
    { role_id: 'r7', permission_id: 'p8' },
    { role_id: 'r7', permission_id: 'p9' },

    // 财务部主管 - 系统管理 + 商城管理 + 用户管理、订单管理、商品管理、财务管理
    { role_id: 'r8', permission_id: 'p2' }, // 添加系统管理权限（父菜单）
    { role_id: 'r8', permission_id: 'p6' }, // 商城管理权限（父菜单）
    { role_id: 'r8', permission_id: 'p3' }, // 用户管理（子菜单）
    { role_id: 'r8', permission_id: 'p7' }, // 订单管理（子菜单）
    { role_id: 'r8', permission_id: 'p8' }, // 商品管理（子菜单）
    { role_id: 'r8', permission_id: 'p9' }  // 财务管理（子菜单）
  ]
